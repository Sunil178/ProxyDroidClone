...
public class ProxyDroid extends PreferenceActivity
    ...
    private void loadNetworkList() {
        ...
        @SuppressLint("MissingPermission") List<WifiConfiguration> wcs = wm.getConfiguredNetworks();
